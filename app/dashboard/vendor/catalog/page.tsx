...
import { getProductsByVendor, getVendorById, getProductById, updateProduct } from '@/lib/data-mongodb'
    ...
    const loadData = async () => {
      try {
        ...
        if (vendorId) {
          ...
          console.error('[VendorCatalogPage] No vendorId found in localStorage')
