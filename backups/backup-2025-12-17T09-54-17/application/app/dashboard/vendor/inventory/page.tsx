...
import { getProductsByVendor, getVendorInventory, updateVendorInventory, getLowStockItems } from '@/lib/data-mongodb'
        ...
        if (vendorProducts.length === 0) {
          ...
          if (inventory.length > 0) {
            ...
            if (productIds.length > 0) {
              ...
              try {
                const { getProductById } = await import('@/lib/data-mongodb')
