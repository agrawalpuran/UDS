...
import { getProductsByCompany, getAllCompanies, getCompanyById, getProductById, updateProduct } from '@/lib/data-mongodb'
...
export default function CatalogPage() {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      // Prepare update data (exclude SKU, vendor, and ID)
                ...
                <div className="p-4 sm:p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div className="relative h-80 bg-white rounded-lg overflow-hidden">
                      <Image
                        src={getIndigoUniformImage(viewModal.product.category, viewModal.product.gender, viewModal.product.name)}
                ...
                <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <label className="block text-sm font-medium text-gray-700">Sizes <span className="text-red-500">*</span></label>
                      <button
                        type="button"
                      ...
                      {editFormData.sizes && editFormData.sizes.map((size: string, index: number) => (
                        <div key={index} className="flex gap-2">
                          <input
                            ...
                            placeholder="Enter size (e.g., S, M, L, XL, 28, 30)"
                  ...
                  <div className="space-y-4 border-t border-gray-200 pt-4">
                    <h3 className="text-lg font-semibold text-gray-900">Attributes (Optional)</h3>
                    
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Attribute 1 Name</label>
                        <input
                          type="text"
                          value={editFormData.attribute1_name || ''}
                          onChange={(e) => setEditFormData({ ...editFormData, attribute1_name: e.target.value })}
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Attribute 1 Value</label>
                        <input
                          type="text"
                          value={editFormData.attribute1_value || ''}
                          onChange={(e) => setEditFormData({ ...editFormData, attribute1_value: e.target.value })}
                          placeholder="e.g., 360, Cotton, Classic Fit"
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none"
                          style={{ '--tw-ring-color': companyPrimaryColor || '#f76b1c' } as React.CSSProperties & { '--tw-ring-color'?: string }}
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Attribute 2 Name</label>
                        <input
                          type="text"
                          value={editFormData.attribute2_name || ''}
                          onChange={(e) => setEditFormData({ ...editFormData, attribute2_name: e.target.value })}
                          placeholder="e.g., GSM, Fabric, Style"
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none"
                          style={{ '--tw-ring-color': companyPrimaryColor || '#f76b1c' } as React.CSSProperties & { '--tw-ring-color'?: string }}
                        />
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Attribute 2 Value</label>
                        <input
                          type="text"
                          value={editFormData.attribute2_value || ''}
                          onChange={(e) => setEditFormData({ ...editFormData, attribute2_value: e.target.value })}
                          placeholder="e.g., 360, Cotton, Classic Fit"
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none"
                          style={{ '--tw-ring-color': companyPrimaryColor || '#f76b1c' } as React.CSSProperties & { '--tw-ring-color'?: string }}
                        />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Attribute 3 Name</label>
                        <input
                          type="text"
                          value={editFormData.attribute3_name || ''}
                          onChange={(e) => setEditFormData({ ...editFormData, attribute3_name: e.target.value })}
                          placeholder="e.g., GSM, Fabric, Style"
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none"
                          style={{ '--tw-ring-color': companyPrimaryColor || '#f76b1c' } as React.CSSProperties & { '--tw-ring-color'?: string }}
                        />
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Attribute 3 Value</label>
                        <input
                          type="text"
                          value={editFormData.attribute3_value || ''}
                          onChange={(e) => setEditFormData({ ...editFormData, attribute3_value: e.target.value })}
                          placeholder="e.g., 360, Cotton, Classic Fit"
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none"
                          style={{ '--tw-ring-color': companyPrimaryColor || '#f76b1c' } as React.CSSProperties & { '--tw-ring-color'?: string }}
                        />
