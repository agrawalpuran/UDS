  ...
  const handleSave = async () => {
    try {
      ...
      if (companyDetails) {
        ...
        const reloadedValue = companyDetails.enableEmployeeOrder === true
        console.log('[Settings] Setting state from reloaded company to:', reloadedValue)
        setEnableEmployeeOrder(reloadedValue)
      }
