...
**Backup Date:** 17/12/2025, 10:06:33 pm
**Backup Timestamp:** 2025-12-17T16-36-30
...
unzip backup-2025-12-17T16-36-30.zip

# Navigate to backup directory
cd backup-2025-12-17T16-36-30/application
...
```bash
# Run restore script
node scripts/restore-database.js backup-2025-12-17T16-36-30/database
```
