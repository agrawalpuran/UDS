...
**Backup Date:** 18/12/2025, 5:04:21 pm
**Backup Timestamp:** 2025-12-18T11-34-18
...
unzip backup-2025-12-18T11-34-18.zip

# Navigate to backup directory
cd backup-2025-12-18T11-34-18/application
...
```bash
# Run restore script
node scripts/restore-database.js backup-2025-12-18T11-34-18/database
```
