...
export async function createProduct(productData: {
  ...
  const schemaChecks = {
    ...
    'stock': {
      ...
      type: 'number',
      default: 0,
      provided: productDataToCreate.stock,
      typeMatch: typeof productDataToCreate.stock === 'number',
      isFinite: typeof productDataToCreate.stock === 'number' && isFinite(productDataToCreate.stock),
    },
    'companyIds': {
      required: false,
      type: 'array',
