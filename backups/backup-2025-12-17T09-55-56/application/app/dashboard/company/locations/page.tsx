  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!currentCompanyId || !currentAdminEmail) {
      if (typeof window !== 'undefined') {
        ...
        currentAdminEmail = localStorage.getItem('userEmail') || 
                           localStorage.getItem('email') || 
                           localStorage.getItem('adminEmail') || 
                           ''
      }
  ...
  const handleRemoveAdmin = async (location: any) => {
    ...
    if (!currentCompanyId || !currentAdminEmail) {
      console.error('Missing credentials:', { 
        ...
        fromLocalStorage: {
          companyId: typeof window !== 'undefined' ? localStorage.getItem('companyId') : 'N/A',
          userEmail: typeof window !== 'undefined' ? localStorage.getItem('userEmail') : 'N/A',
          email: typeof window !== 'undefined' ? localStorage.getItem('email') : 'N/A',
          adminEmail: typeof window !== 'undefined' ? localStorage.getItem('adminEmail') : 'N/A'
        }
      })
      alert('Company ID or Admin Email not found. Please log in again.')
      return
