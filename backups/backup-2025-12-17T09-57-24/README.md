...
**Backup Date:** 17/12/2025, 3:27:30 pm
**Backup Timestamp:** 2025-12-17T09-57-24
...
unzip backup-2025-12-17T09-57-24.zip

# Navigate to backup directory
cd backup-2025-12-17T09-57-24/application
...
```bash
# Run restore script
node scripts/restore-database.js backup-2025-12-17T09-57-24/database
```
